/* ==========================================================================
   AURORA JOURNALS - CORE ENGINE (MULTI-IMAGE GALLERY INTERACTIVE SETUP)
   ========================================================================== */

// Exclusive Live Catalog Data with 4 Gallery Images
const PRODUCTS_DB = [
    {
        id: "soap-bible-journal",
        name: "SOAP Bible Journal",
        price: 8.99,
        // Add your 4 exact filename casing matches right here:
        images: [
            "images/RealTalk.PNG",
...
function renderProductProfileDisplay(detailSurface) {
    ...
    // Build the multiple image slideshow slides dynamically
    let slideImagesHTML = "";
